...
UploadedFileInfo = _reflection.GeneratedProtocolMessageType('UploadedFileInfo', (_message.Message,), dict(
...
FileUploaderState = _reflection.GeneratedProtocolMessageType('FileUploaderState', (_message.Message,), dict(
